<template>
	<div class="grid">
        ...
        <Button icon="pi pi-times" class="p-button-rounded p-button-danger p-button-outlined mr-2 mb-2 lado_derecho" />
        </div>
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="text-900 font-medium text-xl">Vídeo</div>
            </div>
        </div>
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                ...
                <div class="flex align-items-right justify-content-right">
                    <Button label="Añadir a recomendados" class="p-button-success mr-2 mb-2" />
                </div>
            </div>
        </div>
         <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="text-900 font-medium text-xl">Imagen grupos musculares</div>
            </div>
        </div>
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
